...
def browse():
    try:
        ...
        filename = filedialog.askopenfilename(initialdir="C:/Users/I.L.U NIRA/Desktop",filetypes=(("png files","*.png"),("jpg files","*.jpg"),("jpeg files","*.jpeg")))
        path = filename
    except:
...
def final_encryption(path,message):
    ...
    secret_message.save("C:/Users/I.L.U NIRA/Desktop/encrypted/secret_message.png")
    messagebox.showinfo("Saved","Encryped file stored in C:/Users/I.L.U NIRA/Desktop/encrypted")
